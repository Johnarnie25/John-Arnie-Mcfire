...
<label class="col-md-3 control-label"> Branch Title : </label>
...
<label class="col-md-3 control-label"> Branch Button : </label>
...
<label class="col-md-3 control-label"> Branch Url : </label>
...
if (!isset($_SESSION['admin_email'])) {
  ...
  if (isset($_POST['submit'])) {
      ...
      if ($count == 3) {
          ...
          if ($run_store) {
              echo "<script>alert('New store Column Has Been Inserted')</script>";
              echo "<script>window.open('localstore.php','_self')</script>";
          }
      }
  }
}
