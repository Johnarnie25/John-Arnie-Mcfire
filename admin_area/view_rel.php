...
<a href="#" onclick="confirmDelete(<?php echo $rel_id; ?>)" class="btn btn-danger">
...
<a href="index.php?edit_rel=<?php echo $rel_id; ?>" class="btn btn-success">
...
function confirmDelete(relId) {
    if (confirm('Are you sure you want to delete this relation?')) {
        ...
        xhttp.open("GET", "delete_rel.php?rel_id=" + relId, true);
        xhttp.send();
    }
}
</script>
