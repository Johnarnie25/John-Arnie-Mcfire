...
$cat_title = isset($row_cat['cat_title']) ? $row_cat['cat_title'] : null;
...
Product Url Example : Nike-Tshirt-Black
...
if (isset($_POST['update'])) {
    ...
    if ($stmt) {
        mysqli_stmt_bind_param($stmt, 'iiissssssssssssss', $product_cat, $cat, $manufacturer_id, $product_title, $product_url, $product_img1, $product_img2, $product_img3, $product_price, $psp_price, $product_desc, $product_features, $product_video, $product_keywords, $product_label, $status, $p_id);
