...
<i class="fa fa-dashboard"></i> Dashboard / Insert Nic / MG
...
<i class="fa fa-money fa-fw"></i> Insert Nic / MG
...
<label class="col-md-3 control-label">Nic / MG Title</label>
...
<label class="col-md-3 control-label">Show as Nic / MG Top</label>
...
<label class="col-md-3 control-label">Select Nic / MG Image</label>
