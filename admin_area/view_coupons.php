...
<a href="#" onclick="confirmDelete(<?php echo $coupon_id; ?>)" class="btn btn-danger">
...
<a href="index.php?edit_coupon=<?php echo $coupon_id; ?>" class="btn btn-success">
...
function confirmDelete(couponId) {
    if (confirm('Are you sure you want to delete this coupon?')) {
        ...
        xhttp.open("GET", "delete_coupon.php?coupon_id=" + couponId, true);
        xhttp.send();
    }
}
</script>
