...
Product Url Example : Flava-Dispo-Default
...
<label class="col-md-3 control-label" > Select A Brands </label>
...
<label class="col-md-3 control-label" > Accesories </label>

<div class="col-md-6" >

<select name="product_cat" class="form-control" >

<option> Select  Accesories </option>
...
<label class="col-md-3 control-label" > Nic / MG </label>
...
if(isset($_POST['submit'])){
  ...
  $product_label = isset($_POST['product_label']) ? $_POST['product_label'] : '';
  ...
  mysqli_stmt_bind_param($stmt, "iiisssssssssssss", $product_cat, $cat, $manufacturer_id, $product_title, $product_url, $product_img1, $product_img2, $product_img3, $product_price, $psp_price, $product_desc, $product_features, $product_video, $product_keywords, $product_label, $status);
