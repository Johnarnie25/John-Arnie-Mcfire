...
<i class="fa fa-dashboard"></i> Dashboard / Insert Accesories
...
<i class="fa fa-money fa-fw" ></i> Insert Accesories
...
<label class="col-md-3 control-label" >Show as Top Accesories</label>
