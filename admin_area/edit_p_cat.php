...
<i class="fa fa-dashboard"></i> Dashboard / Edit Accesories
...
<i class="fa fa-money fa-fw" ></i> Edit Accesories
...
<label class="col-md-3 control-label" >Accesories Title</label>
...
<label class="col-md-3 control-label" >Show as Top Accesories Category</label>
...
<label class="col-md-3 control-label" > Select Accesories Image</label>
