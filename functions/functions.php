...
$db = mysqli_connect("localhost","u872502285_mcfire","Mcfire_123","u872502285_mcfire");
...
function total_price()
{
    ...
    echo "₱" . number_format($total, 2); // Format the total amount as currency
}
...
function getPro()
{
    ...
    while ($row_products = mysqli_fetch_array($run_products)) {
        ...
        if ($row_manufacturer !== null) {
            $manufacturer_name = $row_manufacturer['manufacturer_title'];
        } else {
            $manufacturer_name = 'Unknown Manufacturer'; // Provide a default value or handle the case when $row_manufacturer is null
        }
        ...
        if ($pro_label == "Sale" or $pro_label == "Gift") {
          $product_price = "<del> ₱" . number_format($pro_price, 2) . " </del>";
          $product_psp_price = "| ₱" . number_format($pro_psp_price, 2);
      } else {
          $product_psp_price = "";
          $product_price = "₱" . number_format($pro_price, 2);
      }
...
function getProducts()
{
    ...
    $get_products = "SELECT * FROM products $sWhere $sLimit";
